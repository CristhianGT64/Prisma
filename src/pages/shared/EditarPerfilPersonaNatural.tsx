                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col">
                    ...
                    <div className="flex flex-col gap-3">
                        <div>
                            ...
                            <input name="nombres" value={form.nombres} onChange={handleChange} required className={inputClasses} placeholder="Juan Alberto" />
                        </div>
                        <div>
                            <label className={labelClasses}>Apellidos *</label>
                            <input name="apellidos" value={form.apellidos} onChange={handleChange} required className={inputClasses} placeholder="Gómez Pérez" />
                        </div>
                        <div>
