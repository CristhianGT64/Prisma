...
export default function BottomNav() {
  ...
  const activeColor = isArrendador ? "text-[#FF9800]" : "text-[#00BFA5]";

  const navItemsArrendador: NavItem[] = [
    { label: "Inicio", icon: <HomeIcon />, path: "/inicio" },
    { label: "Espacios", icon: <BuildingIcon />, path: "/arrendador/espacios" },
    { label: "Reservas", icon: <CalendarIcon />, path: "/arrendador/reservas" },
    { label: "Ingresos", icon: <ChartIcon />, path: "/arrendador/ingresos" },
